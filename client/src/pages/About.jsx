...
import profileImage from "../images/review/about.png"; // Adjust the path as needed
      ...
      <div className="max-w-2xl mx-auto p-6 text-center">
        <div className="mb-6">
          <img
            src={profileImage}
            alt="Madhulika Dubey"
            className="w-32 h-32 rounded-full mx-auto shadow-xl shadow-purple-700 bg-slate-600 dark:bg-slate-400"
          />
        </div>
        ...
        <div className="text-lg text-gray-700 dark:text-white">
          <p className="mb-6">
            ...
            wide array of technologies including Java, Spring, Spring Boot Rest,
            Microservices, Angular 11, React JS, AWS, Docker, and Kubernetes,
            with proficiency in databases such as Oracle, MySQL, and Postgres.
          </p>
          ...
          <ul className="list-disc list-inside mb-6 text-left">
            <li>
              Creating APIs: Utilizing Spring Boot to develop robust RESTful and
              microservices-based APIs, ensuring seamless integration and
              performance.
            </li>
            <li>
              API Management: Proficient in using tools like Postman and Swagger
              for efficient API management, documentation, and testing.
            </li>
            <li>
            ...
            <li>
              Bug Fixing and Unit Testing: Diligent in identifying and resolving
              bugs, along with performing thorough unit testing to ensure code
          ...
          <p>
            My career is driven by a passion for continuous learning and staying
            abreast of emerging technologies, which allows me to deliver
            cutting-edge solutions and provide exceptional training and
            consulting services.
          </p>
        </div>
      </div>
